...
import (
	"encoding/json"
	"github.com/rune/baseapp/x/nameservice"
	"io"
	"os"
...
// NewbaseappApp is a constructor function for baseappApp
func NewInitApp(
	...
	app.mm.SetOrderBeginBlockers(distr.ModuleName, slashing.ModuleName, nameservice.ModuleName)
